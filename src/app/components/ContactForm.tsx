...
export function ContactForm({ onSuccess }: ContactFormProps) {
  ...
  // ✅ Backend API base (safe for local + deploy)
  const API_BASE =
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <button
        type="submit"
        disabled={isSending}
        className="w-full px-8 py-4 bg-gradient-to-r from-purple-600 via-pink-500 to-orange-500 text-white rounded-lg flex items-center justify-center gap-2 shadow-lg hover:shadow-xl disabled:opacity-70"
      >
